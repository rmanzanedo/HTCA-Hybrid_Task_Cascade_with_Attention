...
from detectron2.modeling import META_ARCH_REGISTRY, META_ARCH_REGISTRY1, build_backbone, build_sem_seg_head, build_backbone1
...
class MaskFormer(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        # print('img id: {}'.format(batched_inputs[0]['image_id']))
