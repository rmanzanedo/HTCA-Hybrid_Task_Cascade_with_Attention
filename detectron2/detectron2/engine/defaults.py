...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg, inspector_effi=None):
        ...
        model = self.build_model(cfg, inspector_effi)
        ...
        # self.inspector = inspector_effi
        # self.diver = driver_effi
    ...
    def build_hooks(self):
        ...
        if comm.is_main_process():
            ...
            ########## Mi codigo ###########
            ret.append(hooks.PeriodicWriter(self.build_writers(), period=500))
        return ret
    ...
    @classmethod
    def build_model(cls, cfg, inspector_effi = None, driver_effi = None):
        """
        Returns:
            torch.nn.Module:
        ...
        """
        if inspector_effi is not None:
            model = build_model1(cfg, inspector_effi)
        else:
